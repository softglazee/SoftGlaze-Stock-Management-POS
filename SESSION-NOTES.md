...
**Next:** Batch C is fully done (C1–C6). Next up is **Batch D — inventory & purchasing** (D1 cost/price history · D2 negative-stock/backorder · D3 barcode/shelf-label print · D4 vendor debit/credit notes · D5 PO→GRN flow), per `docs/13`.
