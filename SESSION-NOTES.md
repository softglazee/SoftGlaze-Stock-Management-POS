...
**Next:** C4 — site-wise customer sub-ledgers (one contractor, multiple sites/projects, separate udhaar per site; accounting-sensitive — per-site balances must roll up to the customer's single balance).
