...
import { Plus, Pencil, Trash2, Tags, Receipt } from "lucide-react";
import { api, ApiError } from "../lib/api";
import { Expense, ExpenseCategory, Account, Paged } from "../lib/types";
              ...
              <tbody>
                {expenses.map((e) => (
                  <tr key={e.id} className="border-b border-edge last:border-0 hover:bg-surface-2/50">
                    <td className="px-4 py-2 mono text-xs">{e.refNo}</td>
