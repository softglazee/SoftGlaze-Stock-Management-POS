  ...
  return (
    <div className="space-y-3">
      <div className="grid gap-3 lg:grid-cols-3">
        ...
        <div className="card p-4"><h3 className="font-semibold display mb-2">Equity (your stake)</h3><Row label="Capital" value={bs.equity.capital} />{num(bs.equity.openingStock) !== 0 && <Row label="Opening stock" value={bs.equity.openingStock} />}<Row label="Drawings" value={`-${num(bs.equity.drawings)}`} /><Row label="Retained profit" value={bs.equity.retainedEarnings} /><Row label="Total equity" value={bs.equity.total} bold /></div>
      </div>
